...
<p align="center">
  ...
  <a href="#testing"><img src="https://img.shields.io/badge/tests-858%20passing-brightgreen" alt="Tests"/></a>
...
- **858 tests** — pytest test suite, all passing
...
```bash
pytest -v          # 858 tests, all passing
```
